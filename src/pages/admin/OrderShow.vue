    ...
    <q-card class="my-card" flat bordered>
      ...
      <q-card-section>
        ...
        <OrdersOverviewTable
          ...
          @removeFromOrder="
            (entity, productId) =>
              removeFromOrder(entity, productId, path, orderId)
          "
        ></OrdersOverviewTable>
        <TableProduct
          ...
          @addSelectedItems="
            (entity, productsIds) =>
              addSelectedItems(entity, productsIds, path, orderId)
          "
...
const ordersOrProducts = ref(false);

const removeFromOrder = async (entity, entityId, parentEntity, parentId) => {
